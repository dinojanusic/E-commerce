    ...
    <div class="row mt-3">
      <div class="col-md-6">
        <div class="form-group">
          ...
          {{Form::text('name', $product->name, ['class' => 'form-control', 'placeholder' => 'Upiši svoje ime i prezime...'])}}
        </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            {{Form::label('description', 'Opis')}}
            {{Form::text('description',$product->description, ['class' => 'form-control', 'placeholder' => 'Upiši svoju e-mail adresu..'])}}
          </div>
          </div>
      </div>
      <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              {{Form::text('price',$product->price, ['class' => 'form-control password', 'placeholder' => 'Ovdje upšite svoju lozinku...'])}}
            </div>
          </div>
            <div class="col-md-6">
          ...
          <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  {{Form::select('category_id','', ['class' => 'form-control password', 'placeholder' => 'Ovdje upšite svoju lozinku...'])}}
