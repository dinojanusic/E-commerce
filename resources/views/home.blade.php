...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-md-10">
      <div data-spy="scroll" data-target="#navbar-example3" data-offset="0">
          <h4 id="item-1"><h3 style="border-bottom:1px solid #0d47a1;">Novo</h3></h4>
      <br>
          ...
          @if (count($products) > 0)
              <div class="row">
                  @foreach ($products as $product)
                    <div class="col-md-3">
                    <div class="card mb-3">
          <img class="card-img-top" style="height:10rem; width:100%;" src="/storage/photo/{{$product->photo}}" alt="Card image cap">
          <div class="card-body">
          ...
          @else
              ...
              <p>Nema korisnika</p>
          @endif
      <h4 id="item-2"><h3 style="border-bottom:1px solid #0d47a1;">Laptopi</h3></h4>
      <div class="row">
          @foreach ($product_laptops as $product)
            <div class="col-md-3">
            <div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="justify-content-center text-center">
      ...
      <h4 id="item-3"><h3 style="border-bottom:1px solid #0d47a1;">Televizori</h3></h4>
      <div class="row">
          @foreach ($product_tv as $product)
            <div class="col-md-3">
            <div class="card mb-3">
  <img class="card-img-top img-fluid" style="height:10rem;" src="/storage/photo/{{$product->photo}}" alt="Card image cap">
  <div class="card-body">
